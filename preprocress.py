...
csvfile = open("backpropagation_output_table.csv", 'w')
...
def main(trainSentences, testSentences, featureSet, maxIterations, learningRate=1):
    ...
    num_hidden = 5 #int(nWords/2)
    # nn = NeuralNetwork(len(training_sets[0][0]), num_hidden, len(training_sets[0][1]), hidden_layer_weights=1.0, hidden_layer_bias=0.7,  output_layer_weights =1.0, output_layer_bias=0.3)
    nn = NeuralNetwork(len(training_sets[0][0]), num_hidden, len(training_sets[0][1]), hidden_layer_bias=0.7, output_layer_bias=0.3)
    for i in range(0,100):
        ...
        for i in range(len(training_sets)):
            ...
            print(i, nn.get_output_layer())
            print()

    print(nn.calculate_total_error(training_sets))

    # for temp_test in training_sets:
    #     print(temp_test)
    #     nn.perdict(temp_test)

    for i in range(200):
        test_temp = random.choice(training_sets)
        print(test_temp)
        nn.perdict(test_temp)
        print()
    ...
    #     training_inputs, training_outputs = se
    #     print(training_inputs, training_outputs)
    #     # print(training_inputs)
    #     # print(training_outputs)
    #     nn.train(training_inputs, training_outputs)
    ...
    #         wet[dictionary[word]] = 1
    #     if yt == 1:
    #         pos_training.append(wet)
    #     elif yt == -1:
    #         neg_training.append(wet)
    #
    # for i in range(0,len(pos_training),5):
    #     training_sets.append([pos_training[i:i+5],[1]])
    #     training_sets.append([neg_training[i:i+5],[0]])
    # print(training_sets)
    # print(len(training_sets[0][0]))
    # print(len(training_sets[1][0]))
    # for i, j in training_sets:
    #     if len(i) != 5:
    #         training_sets.remove([i,j])
    #         print("shit!")
    #
    # for i, j in training_sets:
    #     if len(i) != 5:
    ...
    #         print("shit!")
    #
    # training_sets = training_sets[0:4]
    # # training sets bayad yek araye bashe ke darjahaye marbote yek shode bashe
    # num_hidden = 5 #int(nWords/2)
    # nn = NeuralNetwork(len(training_sets[0][0]), num_hidden, len(training_sets[0][1]), hidden_layer_bias=0.0, output_layer_bias=0.0)
