...
fieldnames = ['Max Iterations', 'Feature Set','Learning Rate', 'Type Set', 'Total Error', 'MATCHES', 'MISMATCHES', 'TRUE POSITIVES', 'TRUE NEGATIVES',
...
def experiment(wt_set, set,nn, outputs_file):
...
def main(trainSentences, testSentences, featureSet, maxIterations, learningRate=1):
    ...
    outputs_file.write("\nTraining\n")
    experiment(training_sets, training, nn, outputs_file)
    ...
    row[fieldnames[indexRow-1]] = "Test"
    row[fieldnames[indexRow]] = total_error_test
    outputs_file.write("\nTesting\n")
    experiment(testing_sets, testing, nn,outputs_file)
